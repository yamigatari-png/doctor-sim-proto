...
const ENDING_HINT_MAP: Record<EndingId, string> = {
  normal_pneumonia: "発熱、咳、黄色痰があり、喉や鼻の症状がなければ肺や気管支の病気を考えます。\n急性の経過で胸の写真に影があえばきっとあの病気に間違いない！",
  admission_condition: "患者さんの体力が尽きてしまう前に診断しないと大変なことに！",
  admission_time: "時間をかけすぎたら体調が悪化してしまうかも……",
  trust_break: "失礼な発言や雑なふるまいは信頼をなくしちゃうよ。",
  misdiagnosis: "必要な情報が足りないまま診断すると誤診につながってしまうかも。",
  father_truth: "家族歴（家族が病気を患っているか）を聞き、父の話を深掘ってみよう。お父さんはなぜそんな性格になってしまったんだろう……\n（ハードルを上げてしまうと深い話をする気にならないかも）",
  honeytrap_scam: "女性関係はいつの時代も……。でもそれ、別の目的があるんじゃない？\n（ハードルを上げてしまうと深い話をする気にならないかも）",
