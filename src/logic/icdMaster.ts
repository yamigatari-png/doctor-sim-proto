...
export const ICD_MASTER: DiagnosisOption[] = [
  ...
  { code: "J14", label: "インフルエンザ菌性肺炎" },
  { code: "J15.0", label: "クレブシエラ肺炎" },
  { code: "J15.1", label: "緑膿菌性肺炎" },
  { code: "J15.2", label: "ブドウ球菌性肺炎" },
  { code: "J15.3", label: "A群レンサ球菌性肺炎" },
  { code: "J15.4", label: "その他のレンサ球菌性肺炎" },
  { code: "J15.6", label: "その他のグラム陰性菌性肺炎" },
  { code: "J15.7", label: "マイコプラズマ肺炎" },
  { code: "J15.8", label: "その他の細菌性肺炎" },
  { code: "J15.9", label: "細菌性肺炎" },
  { code: "J16.0", label: "クラミジア肺炎" },
  { code: "J16.8", label: "その他の感染性肺炎" },
  { code: "J18.0", label: "気管支肺炎" },
  { code: "J18.1", label: "大葉性肺炎" },
